package com.db.authserver.config;
...
public class SecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        ...
        RegisteredClient oidcClient1 = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://127.0.0.1:9091/oidc-client")
        ...
        RegisteredClient oidcClient2 = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .clientSettings(ClientSettings.builder().requireAuthorizationConsent(true).build())
                .build();
        registeredClients.add(oidcClient1);
        registeredClients.add(oidcClient2);
    ...
    WebClient webClient(ReactiveClientRegistrationRepository clientRegistration) {
        ...
        oauth.setDefaultClientRegistrationId("client1");
